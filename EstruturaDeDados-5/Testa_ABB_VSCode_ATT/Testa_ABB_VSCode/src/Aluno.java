...
public class Aluno implements Comparable<Aluno> {
    ...
    public String toString() {
        return rgm + " - " + nome + ", sexo: " + sexo + ", media: " + media;
    }
    ...
    @Override
    public int compareTo(Aluno outro) {  // comparamos os nomes
    ...
    /*
    @Override
    public int compareTo(Aluno outro) {  // nesta versão comparamos os RGMs
